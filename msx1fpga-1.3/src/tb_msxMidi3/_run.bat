...
vcom ..\peripheral\i8253\counter.vhd
IF ERRORLEVEL 1 GOTO error
vcom ..\peripheral\i8253\timer.vhd
IF ERRORLEVEL 1 GOTO error
vcom ..\peripheral\i8251\clk_divider.vhd
IF ERRORLEVEL 1 GOTO error
vcom ..\peripheral\i8251\UART_Receiver.vhd
IF ERRORLEVEL 1 GOTO error
vcom ..\peripheral\i8251\UART_transmitter.vhd
IF ERRORLEVEL 1 GOTO error
vcom ..\peripheral\i8251\UART.vhd
IF ERRORLEVEL 1 GOTO error
vcom ..\peripheral\Midi3.vhd
IF ERRORLEVEL 1 GOTO error
